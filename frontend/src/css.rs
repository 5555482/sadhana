...
pub const LINK_CSS: &'static str = "no-underline hover:underline text-base dark:text-zinc-100 text-zinc-500 dark:text-zinc-100";
pub const LINK_CSS_NEW_ACC: &'static str = "no-underline hover:underline text-base text-amber-500 dark:text-amber-400 dark:amber-200";
pub const SUBMIT_BTN_CSS: &'static str =
    "rounded-md text-white w-full cursor-pointer text-base font-semibold mb-8 border border--amber-600 p-2 outline-none
...
pub const BODY_DIV_CSS: &'static str ="pt-12 text-base leading-6 space-y-10 text-zinc-600 dark:text-zinc-100 sm:leading-7 overflow-x-hidden overflow-y-auto scrolling-touch lg:max-h-sm scrollbar-w-2 scrollbar-track-gray-lighter scrollbar-thumb-rounded scrollbar-thumb-gray";
pub const MENU_CSS: &'static str ="text-zinc-600  dark:text-text-zinc-100 text-2xl flex justify-between whitespace-nowrap items-center";
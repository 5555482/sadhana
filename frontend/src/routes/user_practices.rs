        ...
        <BlankPage header_label={ Locale::current().select_practices() }>
            ...
            <div class={ BODY_DIV_CSS }>
                    ...
                    ordered_practices.current().iter().enumerate().map ( |(idx, p)| {
                        html! {
                            <div
                                ...
                                <label draggable="true" class="px-2 py-1 touch-none"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <div>
                    ...
                    <button onclick={ onclick_done.clone() } class={ SUBMIT_BTN_CSS }><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  { format!(" {}", Locale::current().done()) }</button>
                </div>
            </div>
        </BlankPage>
    }
